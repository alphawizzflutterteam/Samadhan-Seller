...
class _HomeScreenState extends State<HomeScreen> {
  ...
  getCheckStatusApi() async {
    try {
      ...
      var request = http.MultipartRequest(
          'POST', Uri.parse('${baseUrl}online_ofline_status'));
                          ...
                          children: [
                            Container(
                              ...
                              padding: EdgeInsets.only(
                                  left: 8.33.w, bottom: 10.87.h, right: 8.33.w),
                              width: 100.w,
                              decoration: BoxDecoration(
  ...
  Future updateSellerStatus(status) async {
    ...
    request.fields
        .addAll({'status': status.toString(), 'user_id': '$CUR_USERID'});
    print('Online Status${request.fields}_________');
    request.headers.addAll(headers);
...
//========================= Third Row Implimentation ===========================
        ...
        child: Column(
          ...
          children: [
            ...
            NewButton(
              selected: false,
              textContent:
                  getTranslated(context, 'TRY_AGAIN_INT_LBL').toString(),
              onPressed: () {
  ...
  Future<void> updateOrder(
    ...
    if (true) {
      ...
      setSnackbar(
          'You have not authorized permission for update order!!', context);
    }
  }
  ...
  Future<Null> getOrder() async {
    if (readOrder) {
      ...
      setSnackbar(
          'You have not authorized permission for read order!!', context);
    }
  }
