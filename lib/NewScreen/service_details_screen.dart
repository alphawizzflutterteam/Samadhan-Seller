...
//========================= getDeliveryBoy API =================================
            ...
            if (data.length != 0) {
              ...
              if (selectedDelBoy == -1) {
                ...
                if (selectedDelBoy != null) {
                  type = delBoyList[int.parse(selectedDelBoy.toString())]
                      .name
                      .toString();
                }
              }
                                ...
                                child: Center(
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      //                 .toString();
                                      //             driverFcmID =
                                      //                 model!.driverfcm.toString();
                                      //             driverFid = model!.driverfuid
                                      //                 .toString();
                                      //             if (driverFid != "" &&
                                      //                 driverFid != null &&
                                      //                 driverFid != "0") {
                                      ...
                                      //             fcmID = model!.userfcm_id
                                      //                 .toString();
                                      //             fid =
                                      //                 model!.userfuid.toString();
                                      //             if (fid != "" &&
                                      //                 fid != null &&
                                      //                 fid != "0") {
                                      //               callChatUser();
  ...
  _handlePressed(
      types.User otherUser, BuildContext context, String fcmID, name) async {
