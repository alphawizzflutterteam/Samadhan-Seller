  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: WillPopScope(
        ...
        child: Scaffold(
          key: _key,
          endDrawer: Drawer(child: Oredrfilter(
                                                            ...
                                                            item.latitude !=
                                                                ...
                                                                ? text(
                                                                    ...
                                                                    calculateDistance(
                                                                                ...
                                                                                item.sellerLat.toString(),
                                                                                item.sellerLng.toString())
                                                                            .toStringAsFixed(1) +
                                                                        "Km",
                                                                    textColor:
                                                                        Color(
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, int i) {
                          ...
                          try {
                            model = (orderList.isEmpty ? null : orderList[i])!;
                            if (scrollLoadmore &&
                          ...
                          return model.itemList![0].activeStatus != PLACED
                              ? InkWell(
                                  onTap: () {
                                    // Navigator.push(
                                    //     context,
