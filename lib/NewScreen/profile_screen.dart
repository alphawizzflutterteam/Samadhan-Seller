...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  getSaveDetail() async {
    ...
    setState(() {
      ...
      LOGO = prefs.getString(StoreLogo) ?? '';
      print(image);
    });
  }
  ...
  Future<DeleteAccountModel?> deleteAccount() async {
    ...
    var request = http.MultipartRequest('POST',
        Uri.parse('https://entemarket.com/seller/app/v1/api/delete_sellers'));
    request.headers.addAll(header);
    request.fields.addAll({'id': CUR_USERID.toString()});
            ...
            child: AnimatedContainer(
              ...
              child: Column(
                children: [
                  ...
                  tabItem(context, 7, "images/service_history.png",
                      "Term and Conditions"),
                  SizedBox(
                    height: 2.5.h,
                  ),
